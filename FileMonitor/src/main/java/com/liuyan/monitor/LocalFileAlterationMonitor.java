...
public class LocalFileAlterationMonitor {
    ...
    public LocalFileAlterationMonitor(){
        this.interval = DEFAULT_INTERVAL;
    }

    public LocalFileAlterationMonitor(String path, String fileSuffix, FileAlterationListenerAdaptor listenerAdaptor){
        this.path = path;
    ...
    public LocalFileAlterationMonitor(String path, String fileSuffix, long interval, FileAlterationListenerAdaptor listenerAdaptor) {
        this.path = path;
        this.fileSuffix = fileSuffix;
